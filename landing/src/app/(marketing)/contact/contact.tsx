...
import { CreateContactFormRequest } from "@/app/api/types/contact.types";
...
export function ContactForm() {
  ...
  async function onSubmit(values: LoginUser) {
    try {
      ...
      const { data } = await axios.post(
        `/api/contact`,
        { email: values.email, message: values.message, company: values.company, name: values.name } as CreateContactFormRequest
      );
  ...
  const socials = [
    {
      title: "twitter",
      href: "https://twitter.com/armitagelabs",
      icon: (
        <IconBrandX className="h-5 w-5 text-black dark:text-muted-dark hover:text-black" />
      ),
    },
    {
      title: "github",
      href: "https://github.com/armitagelabs",
      icon: (
        <IconBrandGithub className="h-5 w-5 text-black dark:text-muted-dark hover:text-black" />
      ),
    },
    {
      title: "linkedin",
      href: "https://www.linkedin.com/company/armitage-labs",
      icon: (
        <IconBrandLinkedin className="h-5 w-5 text-black dark:text-muted-dark hover:text-black" />
      ),
    },
  ];
        ...
        <div className="flex relative z-20 items-center w-full justify-center px-4 py-4 lg:py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-md">
            <div>
              ...
              <p className="mt-4 text-black text-sm max-w-sm">
