...
const prices = [
  97.56, 104.34, 172.25, 232.4, 288.76, 334.8, 335.56, 367.38, 381.21, 409.6,
  494.39, 521.32, 594.03, 610.1, 629.2, 649.56, 667.03, 683.4, 690.14, 700.6,
  722.11, 731.19, 738.89, 761.7, 794.51, 800.3, 838.0, 843.3, 851.64, 860.51,
  871.45, 879.68, 993.56,
]
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            ...
            <div className="text-sm text-gray-900">$JPC</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            <div className="flex items-baseline gap-2">
              ...
              <div className="text-sm text-gray-900">USDc</div>
              {percentageChange && (
                <div
                  className={clsx(
